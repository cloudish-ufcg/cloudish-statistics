...
PlotHostUsage <- function(usage, datacenter.type, hosts = 1, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotHostUtilizationAndAvailable <- function(usage, datacenter.type, host.capacity, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotHostUtilization <- function(usage, datacenter.type, host.capacity, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotHostUtilizationByPriority <- function(usage, datacenter.type, host.capacity, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
