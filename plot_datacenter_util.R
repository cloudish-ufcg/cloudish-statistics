...
PlotAllocatedVms <- function(datacenter.info, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotWaitingVms <- function(datacenter.info, limit, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotWaitingResources <- function(datacenter.info, limit, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotProportionOfAllocatedVms <- function(datacenter.info, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
...
PlotProportionOfAllocatedResources <- function(datacenter.info, output.dir, plot.width = 450 , plot.height = 450, overwrite.plot = T) {
